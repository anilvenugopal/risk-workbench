"""Row makers for the spec-005 breakout tests — raw INSERTs against the
WORKBENCH database the ``workbench_db`` fixture provisions, shared by the gate,
plan, page-state, worker, prune/re-run, group, and route modules.
"""
