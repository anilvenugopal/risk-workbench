"""SQL Server tests for the global EDM/RDM libraries (US7, T057).
...
Runs against the dedicated SQL Server test database.
"""
...
def _submission(*, name, inserted_at) -> str:
    ...
    execute_command(
        ...
        "SELECT TOP (1) :id, id, :name, 'Cedant', 'cat_xol', '2026-01-01', "
        "'ACTIVE', :now, :now FROM app_user ORDER BY id",
