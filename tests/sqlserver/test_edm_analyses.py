...
def test_expanded_row_renders_metadata_results_and_perspective_toggle(
    ...
    _seed_executed(
        ...
        inserted_by=workbench_db.user_a,
...
def test_contextual_merged_section_holds_both_origins(client, workbench_db):
    submission_id, edm_id, rdm_id = _seed_contextual(workbench_db)
...
def test_contextual_rdm_lazy_rows_use_the_merged_columns(client, workbench_db):
    submission_id, edm_id, rdm_id = _seed_contextual(workbench_db)
    _analysis(rdm_id, "88215", "FL HU Gross 2026")
