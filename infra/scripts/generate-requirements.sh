...
# anything." The remaining flags exclude the development dependency group
# and the editable risk-workbench package itself while retaining the locked
# irp-pypi runtime group.
GENERATED="$(uv export --frozen --no-dev --no-emit-project)"
