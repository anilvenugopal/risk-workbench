...
- O-01, O-02, and O-03 closed 2026-09-16 by the user: the analyst picks the treaties to export (P-03, reversed to that on 2026-09-17), data name plus treaty number and name (P-06), per-treaty AAL from the loaded rows and none in the cart (P-10). FR-002, FR-009, and FR-016 carry them.
