...
- [x] T006 [US1] [FR-001] [P-05] `app/services/export_service.py` `list_exportable_analyses`: `TY` appended to `perspectives` when `loss_results.treaties` is non-empty; `create_export`'s per-analysis message at TY reads "{name} has no treaty with TY loss." (P-13)
