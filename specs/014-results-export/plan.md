...
| O-02 | TY treaty-level export: what Risk Modeler produces, what `Data` row it maps to | Closed 2026-09-16 | Spec 016: `TY` is in `EXPORT_PERSPECTIVE_CODES`; one `Data` row per treaty per analysis, one manifest row each |
