...
- [ ] T061 Click-through per quickstart.md §3 steps 4 and 9 on a stack running irp-integration `0.8.0rc9` or the local checkout (`make irp-local`), then the diff subtraction review
