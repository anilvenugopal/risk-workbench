...
| P-03 | Approved | Show separate, always-visible EDM and RDM tables on submission detail. The EDM table shows Name, Portfolio count, and a Risk Modeler link. The RDM table shows Name, Analysis count, and a Risk Modeler link. The tables do not expand or collapse. |
...
- **FR-006**: The EDM and RDM tables MUST remain visible, MUST NOT expand or collapse, and MUST include empty states. The EDM table MUST show Name, Portfolio count, and a Risk Modeler link. The RDM table MUST show Name, Analysis count, and a Risk Modeler link.
