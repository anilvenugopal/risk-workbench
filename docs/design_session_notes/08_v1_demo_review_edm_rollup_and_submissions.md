...
| **Required fields: name, cedant, treaty type, inception date** (D4) | Cheryl: *"seems fair."* With the caveat that **treaty year is derived, not entered** (CR5) — already the stated requirement; the implementation lagged. |
