...
| HD (PLT) results cannot be exported; the form lists them disabled. | Implemented | **Added 9/16 (note 31 D16–D17); spec 014 FR-025.** An HD analysis is greyed on the export form with the reason and cannot be ticked, so no export mixes HD and DLM. HD's future is spec 014 O-08. |
