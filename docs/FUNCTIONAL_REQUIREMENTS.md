...
| The grouping pick-list is scoped to the current submission. | Implemented | Checkboxes on the EDM detail page. **Corrected 8/20** from EDM-scoped to submission-scoped; members can span EDMs and RDMs within the submission. |
