...
4. **Agent context update**:
   - Update the plan reference between the `<!-- SPECKIT START -->` and `<!-- SPECKIT END -->` markers in `AGENTS.md` (the context file configured in `.specify/extensions/agent-context/agent-context-config.yml`) to point to the plan file created in step 1 (the IMPL_PLAN path)
