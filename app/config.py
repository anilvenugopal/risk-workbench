...
class Settings(BaseSettings):
    ...
    # ── Auth ──────────────────────────────────────────────────────────────────
    # AUTH_MODE=password is a gated fallback for v1. Never reachable in production.
    ...
    def password_auth_enabled(self) -> bool:
        # Server-side guard: password auth is never reachable in production.
        return self.auth_mode == "password" and not self.is_production
