<!-- SPECKIT START -->
When present, read `specs/013-analysis-comparison/plan.md` for the current
...
- [.specify/memory/constitution.md](.specify/memory/constitution.md) — 13 architectural rules (v5.0.0); all compliance gates
